<?php
    ...
    switch($tombol)
    {
        ...
        break;
        case "Selesai":
            header("location:?page=gudang/pembelian");
        break;
        ...
        foreach($q as $qbaru)
        {
            ...
            $data.="
                <tr>
                    ...
                    <td class='text-right'>{$qbaru['harga']}</td>              
                    <td class='text-right'>{$qbaru['total']}</td>
    ...
    $konten = "
        <div class='container mt-5'>
            <form method='post' autocomplete='off' class='ml-3 mr-3'>
                <h1 class='mb-5'>Edit Pembelian</h1>
